...
/*
	...
	// iOS-only (optional)
	// #define RGFW_IOS_METAL          // use Metal instead of OpenGL ES for rendering
	// #define RGFW_IOS_SCENE_DELEGATE // use UISceneDelegate (iOS 13+)
*/
...
/* Apple platform target conditionals */
